      ...
      tags.push(React.createElement.apply(React, [ "section", {
        ...
        tags.push(React.createElement.apply(React, [ "section", {
          ...
          tags.push(React.createElement.apply(React, [ "section", {
            ...
            var tags = [];
            nextQuestions ? tags.push(React.createElement("ul", {
              className: "question-q next-questions-body"
            }, function() {
              var tags = [];
              var $$obj = nextQuestions;
              if ("number" == typeof $$obj.length) for (var $index = 0, $$l = $$obj.length; $$l > $index; $index++) {
                var next = $$obj[$index];
                tags.push(React.createElement("li", {
                  key: "next" + next.tagId,
                  className: "question-q nextQuestions-link"
                }, React.createElement("a", {
                  href: next.uri,
                  rel: next.id,
                  ...
                  className: "name"
                }, next.display), React.createElement(Fa, {
