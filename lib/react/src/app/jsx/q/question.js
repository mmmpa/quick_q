module.exports = (function (React) {
  var fn = function(locals) {
    ...
    (function(Fa, FreeText, InOrder, Loading, MultipleChoices, MultipleQuestions, Ox, QuestionState, SingleChoice, answers, goBack, isCorrect, premise, qTags, question, result, resultText, showTaggedIndex, sourceLink, state, submit) {
      tags.push(React.createElement.apply(React, [ "section", {
        ...
        tags.push(React.createElement.apply(React, [ "section", {
          ...
          question.isFreeText() ? tags.push(React.createElement(FreeText, {
            question: question,
            options: question.options,
            answers: answers,
            result: result
          })) : question.isOx() ? tags.push(React.createElement(Ox, {
            question: question,
            options: question.options,
            answers: answers,
            result: result
          })) : question.isSingleChoice() ? tags.push(React.createElement(SingleChoice, {
            question: question,
            options: question.options,
            answers: answers,
            result: result
          })) : question.isMultipleChoices() ? tags.push(React.createElement(MultipleChoices, {
            question: question,
            options: question.options,
            answers: answers,
            result: result
          })) : question.isInOrder() ? tags.push(React.createElement(InOrder, {
            question: question,
            answers: answers,
            result: result
          })) : question.isMultipleQuestions() && tags.push(React.createElement(MultipleQuestions, {
            question: question,
            answers: answers,
            result: result
          }));
