module.exports = (function (React) {
  var fn = function(locals) {
    ...
    (function(Fa, FreeText, InOrder, Loading, MultipleChoices, Ox, QuestionState, SingleChoice, answers, goBack, qTags, question, result, showTaggedIndex, sourceLink, state, submit) {
